...
function bt1_cb(self::Ptr{Ihandle})
    ...
    IupMglPlotPaintTo(plot, "SVG", 800, 800, 300, filenameSVG);
    return IUP_DEFAULT
end
...
function bt2_cb(self::Ptr{Ihandle})
    ...
    IupMglPlotPaintTo(plot, "EPS", 800, 800, 300, filenameEPS);
    return IUP_DEFAULT
end

#=
# --------------------------------------------------------------------------------------
function bt3_cb(self::Ptr{Ihandle})
...
# --------------------------------------------------------------------------------------
function bt4_cb(self::Ptr{Ihandle})
  global plot, filenamePNG
  IupGetIntInt(plot, "DRAWSIZE", &w, &h);
  gldata = malloc(w*h*3);
