...
function imImageSetAttribute(image::Ptr{imImage}, attrib::String, data_type::Cint, count::Cint, data::Ptr{Void})
...
function imImageGetAttributeList(image::Ptr{imImage}, attrib::Ptr{String}, attrib_count::Ptr{Cint})
  ccall( (:imImageGetAttributeList, libim_image_), Void, (Ptr{imImage}, Ptr{String}, Ptr{Cint}), image, attrib, attrib_count)
end
