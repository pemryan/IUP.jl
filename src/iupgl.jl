...
function IupGLCanvasOpen()
  ccall( (:IupGLCanvasOpen, iup), Cvoid, (), )
end
...
function IupGLMakeCurrent(ih::Ptr{Cint})
  ccall( (:IupGLMakeCurrent, iup), Cvoid, (Ptr{Cint},), ih)
end
...
function IupGLSwapBuffers(ih::Ptr{Cint})
  ccall( (:IupGLSwapBuffers, iup), Cvoid, (Ptr{Cint},), ih)
end

function IupGLPalette(ih::Ptr{Cint}, index::Cint, r::Cfloat, g::Cfloat, b::Cfloat)
  ccall( (:IupGLPalette, iup), Cvoid, (Ptr{Cint}, Cint, Cfloat, Cfloat, Cfloat), ih, index, r, g, b)
end

function IupGLUseFont(ih::Ptr{Cint}, first::Cint, count::Cint, list_base::Cint)
  ccall( (:IupGLUseFont, iup), Cvoid, (Ptr{Cint}, Cint, Cint, Cint), ih, first, count, list_base)
end

function IupGLWait(gl::Cint)
  ccall( (:IupGLWait, iup), Cvoid, (Cint,), gl)
end
