...
const CD_COPYRIGHT = "Copyright (C) 1994-2019 Tecgraf, PUC-Rio."
const CD_VERSION = "5.12"
const CD_VERSION_NUMBER = 512000
const CD_VERSION_DATE = "2019/01/07"
...
mutable struct cdImage
    ...
    h::Cint
    ctximage::Ptr{Cvoid}
    cxGetImage::Ptr{Cvoid}
    cxPutImageRect::Ptr{Cvoid}
    cxKillImage::Ptr{Cvoid}
end

mutable struct cdContext
    caps::Culong
    _type::Cint
    cxCreateCanvas::Ptr{Cvoid}
    cxInitTable::Ptr{Cvoid}
    cxPlay::Ptr{Cvoid}
    cxRegisterCallback::Ptr{Cvoid}
end
...
struct cdCanvas
    ...
    cxChord::Ptr{Cvoid}
    cxText::Ptr{Cvoid}
    cxKillCanvas::Ptr{Cvoid}
    cxFont::Ptr{Cvoid}
    cxPutImageRectMap::Ptr{Cvoid}
    cxPutImageRectRGB::Ptr{Cvoid}
    cxGetFontDim::Ptr{Cvoid}
    cxGetTextSize::Ptr{Cvoid}
    cxFlush::Ptr{Cvoid}
    cxClear::Ptr{Cvoid}
    cxFLine::Ptr{Cvoid}
    cxFPoly::Ptr{Cvoid}
    ...
    cxFText::Ptr{Cvoid}
    cxClip::Ptr{Cvoid}
    cxClipArea::Ptr{Cvoid}
    cxFClipArea::Ptr{Cvoid}
    cxBackOpacity::Ptr{Cvoid}
    cxWriteMode::Ptr{Cvoid}
    cxLineStyle::Ptr{Cvoid}
    cxLineWidth::Ptr{Cvoid}
    cxLineJoin::Ptr{Cvoid}
    cxLineCap::Ptr{Cvoid}
    cxInteriorStyle::Ptr{Cvoid}
    cxHatch::Ptr{Cvoid}
    cxStipple::Ptr{Cvoid}
    cxPattern::Ptr{Cvoid}
    cxNativeFont::Ptr{Cvoid}
    cxTextAlignment::Ptr{Cvoid}
    cxTextOrientation::Ptr{Cvoid}
    cxPalette::Ptr{Cvoid}
    cxBackground::Ptr{Cvoid}
    cxForeground::Ptr{Cvoid}
    cxTransform::Ptr{Cvoid}
    cxPutImageRectRGBA::Ptr{Cvoid}
    cxGetImageRGB::Ptr{Cvoid}
    cxScrollArea::Ptr{Cvoid}
    cxCreateImage::Ptr{Cvoid}
    cxKillImage::Ptr{Cvoid}
    cxGetImage::Ptr{Cvoid}
    cxPutImageRect::Ptr{Cvoid}
    cxNewRegion::Ptr{Cvoid}
    cxIsPointInRegion::Ptr{Cvoid}
    cxOffsetRegion::Ptr{Cvoid}
    cxGetRegionBox::Ptr{Cvoid}
    cxActivate::Ptr{Cvoid}
    cxDeactivate::Ptr{Cvoid}
    w::Cint
    h::Cint
    w_mm::Cdouble
    h_mm::Cdouble
    ...
    attrib_n::Cint
    vector_font::Ptr{Cvoid}
    simulation::Ptr{Cvoid}
    ctxcanvas::Ptr{Cvoid}
    context::Ptr{Cint}
end
...
function cdRegisterAttribute(canvas::Ptr{Cint}, attrib::Ptr{cdAttribute})
  ccall( (:cdRegisterAttribute, libcd_), Cvoid, (Ptr{Cint}, Ptr{cdAttribute}), canvas, attrib)
end

function cdUpdateAttributes(canvas::Ptr{Cint})
  ccall( (:cdUpdateAttributes, libcd_), Cvoid, (Ptr{Cint},), canvas)
end
...
function cdKillVectorFont(vector_font_data::Ptr{Cvoid})
  ccall( (:cdKillVectorFont, libcd_), Cvoid, (Ptr{cdVectorFont},), vector_font_data)
end
=#

function wdSetDefaults(canvas::Ptr{Cint})
  ccall( (:wdSetDefaults, libcd_), Cvoid, (Ptr{Cint},), canvas)
end

function cdInitContextPlusList(ctx_list::Ptr{Ptr{Cint}})
  ccall( (:cdInitContextPlusList, libcd_), Cvoid, (Ptr{Ptr{Cint}},), ctx_list)
end
...
function cdNormalizeLimits(w::Integer, h::Integer, xmin::Ptr{Cint}, xmax::Ptr{Cint}, ymin::Ptr{Cint}, ymax::Ptr{Cint})
  ccall( (:cdNormalizeLimits, libcd_), Cvoid, (Cint, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), w, h, xmin, xmax, ymin, ymax)
end
...
function cdSetPaperSize(size::Integer, w_pt::Ptr{Cdouble}, h_pt::Ptr{Cdouble})
  ccall( (:cdSetPaperSize, libcd_), Cvoid, (Cint, Ptr{Cdouble}, Ptr{Cdouble}), size, w_pt, h_pt)
end
...
function cdCanvasPoly(canvas::Ptr{Cint}, mode::Integer, points::Ptr{cdPoint}, n::Integer)
  ccall( (:cdCanvasPoly, libcd_), Cvoid, (Ptr{Cint}, Cint, Ptr{cdPoint}, Cint), canvas, mode, points, n)
end
...
function cdCanvasGetArcBox(xc::Integer, yc::Integer, w::Integer, h::Integer, a1::Cdouble, a2::Cdouble, xmin::Ptr{Cint}, xmax::Ptr{Cint}, ymin::Ptr{Cint}, ymax::Ptr{Cint})
  ccall( (:cdCanvasGetArcBox, libcd_), Cvoid, (Cint, Cint, Cint, Cint, Cdouble, Cdouble, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), xc, yc, w, h, a1, a2, xmin, xmax, ymin, ymax)
end
...
function cdCanvasGetArcStartEnd(xc::Integer, yc::Integer, w::Integer, h::Integer, a1::Cdouble, a2::Cdouble, x1::Ptr{Cint}, y1::Ptr{Cint}, x2::Ptr{Cint}, y2::Ptr{Cint})
  ccall( (:cdCanvasGetArcStartEnd, libcd_), Cvoid, (Cint, Cint, Cint, Cint, Cdouble, Cdouble, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), xc, yc, w, h, a1, a2, x1, y1, x2, y2)
end
...
function cdfCanvasGetArcStartEnd(xc::Cdouble, yc::Cdouble, w::Cdouble, h::Cdouble, a1::Cdouble, a2::Cdouble, x1::Ptr{Cdouble}, y1::Ptr{Cdouble}, x2::Ptr{Cdouble}, y2::Ptr{Cdouble})
  ccall( (:cdfCanvasGetArcStartEnd, libcd_), Cvoid, (Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), xc, yc, w, h, a1, a2, x1, y1, x2, y2)
end

function cdMatrixTransformPoint(matrix::Ptr{Cdouble}, x::Integer, y::Integer, rx::Ptr{Cint}, ry::Ptr{Cint})
  ccall( (:cdMatrixTransformPoint, libcd_), Cvoid, (Ptr{Cdouble}, Cint, Cint, Ptr{Cint}, Ptr{Cint}), matrix, x, y, rx, ry)
end

function cdfMatrixTransformPoint(matrix::Ptr{Cdouble}, x::Cdouble, y::Cdouble, rx::Ptr{Cdouble}, ry::Ptr{Cdouble})
  ccall( (:cdfMatrixTransformPoint, libcd_), Cvoid, (Ptr{Cdouble}, Cdouble, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}), matrix, x, y, rx, ry)
end

function cdMatrixMultiply(matrix::Ptr{Cdouble}, mul_matrix::Ptr{Cdouble})
  ccall( (:cdMatrixMultiply, libcd_), Cvoid, (Ptr{Cdouble}, Ptr{Cdouble}), matrix, mul_matrix)
end

function cdMatrixInverse(matrix::Ptr{Cdouble}, inv_matrix::Ptr{Cdouble})
  ccall( (:cdMatrixInverse, libcd_), Cvoid, (Ptr{Cdouble}, Ptr{Cdouble}), matrix, inv_matrix)
end
...
function cdfRotatePoint(canvas::Ptr{Cint}, x::Cdouble, y::Cdouble, cx::Cdouble, cy::Cdouble, rx::Ptr{Cdouble}, ry::Ptr{Cdouble}, sin_theta::Cdouble, cos_theta::Cdouble)
  ccall( (:cdfRotatePoint, libcd_), Cvoid, (Ptr{Cint}, Cdouble, Cdouble, Cdouble, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}, Cdouble, Cdouble), canvas, x, y, cx, cy, rx, ry, sin_theta, cos_theta)
end
...
function cdRotatePoint(canvas::Ptr{Cint}, x::Integer, y::Integer, cx::Integer, cy::Integer, rx::Ptr{Cint}, ry::Ptr{Cint}, sin_teta::Cdouble, cos_teta::Cdouble)
  ccall( (:cdRotatePoint, libcd_), Cvoid, (Ptr{Cint}, Cint, Cint, Cint, Cint, Ptr{Cint}, Ptr{Cint}, Cdouble, Cdouble), canvas, x, y, cx, cy, rx, ry, sin_teta, cos_teta)
end
...
function cdRotatePointY(canvas::Ptr{Cint}, x::Integer, y::Integer, cx::Integer, cy::Integer, ry::Ptr{Cint}, sin_theta::Cdouble, cos_theta::Cdouble)
  ccall( (:cdRotatePointY, libcd_), Cvoid, (Ptr{Cint}, Cint, Cint, Cint, Cint, Ptr{Cint}, Cdouble, Cdouble), canvas, x, y, cx, cy, ry, sin_theta, cos_theta)
end
...
function cdTextTranslatePoint(canvas::Ptr{Cint}, x::Integer, y::Integer, w::Integer, h::Integer, baseline::Integer, rx::Ptr{Cint}, ry::Ptr{Cint})
  ccall( (:cdTextTranslatePoint, libcd_), Cvoid, (Ptr{Cint}, Cint, Cint, Cint, Cint, Cint, Ptr{Cint}, Ptr{Cint}), canvas, x, y, w, h, baseline, rx, ry)
end

function cdMovePoint(x::Ptr{Cint}, y::Ptr{Cint}, dx::Cdouble, dy::Cdouble, sin_theta::Cdouble, cos_theta::Cdouble)
  ccall( (:cdMovePoint, libcd_), Cvoid, (Ptr{Cint}, Ptr{Cint}, Cdouble, Cdouble, Cdouble, Cdouble), x, y, dx, dy, sin_theta, cos_theta)
end

function cdfMovePoint(x::Ptr{Cdouble}, y::Ptr{Cdouble}, dx::Cdouble, dy::Cdouble, sin_theta::Cdouble, cos_theta::Cdouble)
  ccall( (:cdfMovePoint, libcd_), Cvoid, (Ptr{Cdouble}, Ptr{Cdouble}, Cdouble, Cdouble, Cdouble, Cdouble), x, y, dx, dy, sin_theta, cos_theta)
end
...
function cdgetfontdimEX(ctxcanvas::Ptr{Cvoid}, max_width::Ptr{Cint}, height::Ptr{Cint}, ascent::Ptr{Cint}, descent::Ptr{Cint})
  ccall( (:cdgetfontdimEX, libcd_), Cvoid, (Ptr{Cvoid}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), ctxcanvas, max_width, height, ascent, descent)
end

function cdgettextsizeEX(ctxcanvas::Ptr{Cvoid}, s::Ptr{UInt8}, len::Integer, width::Ptr{Cint}, height::Ptr{Cint})
  ccall( (:cdgettextsizeEX, libcd_), Cvoid, (Ptr{Cvoid}, Ptr{UInt8}, Cint, Ptr{Cint}, Ptr{Cint}), ctxcanvas, s, len, width, height)
end
...
function cdImageRGBInitInverseTransform(w::Integer, h::Integer, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer, xfactor::Ptr{Cdouble}, yfactor::Ptr{Cdouble}, matrix::Ptr{Cdouble}, inv_matrix::Ptr{Cdouble})
  ccall( (:cdImageRGBInitInverseTransform, libcd_), Cvoid, (Cint, Cint, Cint, Cint, Cint, Cint, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), w, h, xmin, xmax, ymin, ymax, xfactor, yfactor, matrix, inv_matrix)
end
...
function cdImageRGBInverseTransform(t_x::Integer, t_y::Integer, i_x::Ptr{Cdouble}, i_y::Ptr{Cdouble}, xfactor::Cdouble, yfactor::Cdouble, xmin::Integer, ymin::Integer, x::Integer, y::Integer, inv_matrix::Ptr{Cdouble})
  ccall( (:cdImageRGBInverseTransform, libcd_), Cvoid, (Cint, Cint, Ptr{Cdouble}, Ptr{Cdouble}, Cdouble, Cdouble, Cint, Cint, Cint, Cint, Ptr{Cdouble}), t_x, t_y, i_x, i_y, xfactor, yfactor, xmin, ymin, x, y, inv_matrix)
end
...
function cdImageRGBCalcDstLimits(canvas::Ptr{Cint}, x::Integer, y::Integer, w::Integer, h::Integer, xmin::Ptr{Cint}, xmax::Ptr{Cint}, ymin::Ptr{Cint}, ymax::Ptr{Cint}, rect::Ptr{Cint})
  ccall( (:cdImageRGBCalcDstLimits, libcd_), Cvoid, (Ptr{Cint}, Cint, Cint, Cint, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), canvas, x, y, w, h, xmin, xmax, ymin, ymax, rect)
end
...
function cdRGB2Gray(width::Integer, height::Integer, red::Ptr{Cuchar}, green::Ptr{Cuchar}, blue::Ptr{Cuchar}, index::Ptr{Cuchar}, color::Ptr{Clong})
  ccall( (:cdRGB2Gray, libcd_), Cvoid, (Cint, Cint, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Clong}), width, height, red, green, blue, index, color)
end
...
function cdCreateSimulation(canvas::Ptr{Cint})
  ccall( (:cdCreateSimulation, libcd_), Ptr{Cvoid}, (Ptr{Cint},), canvas)
end

function cdKillSimulation(simulation::Ptr{Cvoid})
  ccall( (:cdKillSimulation, libcd_), Cvoid, (Ptr{Cvoid},), simulation)
end

function cdSimInitText(simulation::Ptr{Cvoid})
  ccall( (:cdSimInitText, libcd_), Cvoid, (Ptr{Cvoid},), simulation)
end

function cdSimTextFT(ctxcanvas::Ptr{Cvoid}, x::Integer, y::Integer, s::Ptr{UInt8}, len::Integer)
  ccall( (:cdSimTextFT, libcd_), Cvoid, (Ptr{Cvoid}, Cint, Cint, Ptr{UInt8}, Cint), ctxcanvas, x, y, s, len)
end

function cdSimFontFT(ctxcanvas::Ptr{Cvoid}, type_face::Ptr{UInt8}, style::Integer, size::Integer)
  ccall( (:cdSimFontFT, libcd_), Cint, (Ptr{Cvoid}, Ptr{UInt8}, Cint, Cint), ctxcanvas, type_face, style, size)
end

function cdSimGetFontDimFT(ctxcanvas::Ptr{Cvoid}, max_width::Ptr{Cint}, height::Ptr{Cint}, ascent::Ptr{Cint}, descent::Ptr{Cint})
  ccall( (:cdSimGetFontDimFT, libcd_), Cvoid, (Ptr{Cvoid}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), ctxcanvas, max_width, height, ascent, descent)
end

function cdSimGetTextSizeFT(ctxcanvas::Ptr{Cvoid}, s::Ptr{UInt8}, len::Integer, width::Ptr{Cint}, height::Ptr{Cint})
  ccall( (:cdSimGetTextSizeFT, libcd_), Cvoid, (Ptr{Cvoid}, Ptr{UInt8}, Cint, Ptr{Cint}, Ptr{Cint}), ctxcanvas, s, len, width, height)
end

function cdSimMark(canvas::Ptr{Cint}, x::Integer, y::Integer)
  ccall( (:cdSimMark, libcd_), Cvoid, (Ptr{Cint}, Cint, Cint), canvas, x, y)
end
...
function cdSimPutImageRectRGBA(canvas::Ptr{Cint}, iw::Integer, ih::Integer, r::Ptr{Cuchar}, g::Ptr{Cuchar}, b::Ptr{Cuchar}, a::Ptr{Cuchar}, x::Integer, y::Integer, w::Integer, h::Integer, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdSimPutImageRectRGBA, libcd_), Cvoid, (Ptr{Cint}, Cint, Cint, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), canvas, iw, ih, r, g, b, a, x, y, w, h, xmin, xmax, ymin, ymax)
end
...
function cdSimPutImageRectRGB(canvas::Ptr{Cint}, iw::Integer, ih::Integer, r::Ptr{Cuchar}, g::Ptr{Cuchar}, b::Ptr{Cuchar}, x::Integer, y::Integer, w::Integer, h::Integer, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdSimPutImageRectRGB, libcd_), Cvoid, (Ptr{Cint}, Cint, Cint, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), canvas, iw, ih, r, g, b, x, y, w, h, xmin, xmax, ymin, ymax)
end

function cdSimLine(ctxcanvas::Ptr{Cvoid}, x1::Integer, y1::Integer, x2::Integer, y2::Integer)
  ccall( (:cdSimLine, libcd_), Cvoid, (Ptr{Cvoid}, Cint, Cint, Cint, Cint), ctxcanvas, x1, y1, x2, y2)
end

function cdSimRect(ctxcanvas::Ptr{Cvoid}, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdSimRect, libcd_), Cvoid, (Ptr{Cvoid}, Cint, Cint, Cint, Cint), ctxcanvas, xmin, xmax, ymin, ymax)
end

function cdSimBox(ctxcanvas::Ptr{Cvoid}, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdSimBox, libcd_), Cvoid, (Ptr{Cvoid}, Cint, Cint, Cint, Cint), ctxcanvas, xmin, xmax, ymin, ymax)
end

function cdSimArc(ctxcanvas::Ptr{Cvoid}, xc::Integer, yc::Integer, width::Integer, height::Integer, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdSimArc, libcd_), Cvoid, (Ptr{Cvoid}, Cint, Cint, Cint, Cint, Cdouble, Cdouble), ctxcanvas, xc, yc, width, height, angle1, angle2)
end

function cdSimSector(ctxcanvas::Ptr{Cvoid}, xc::Integer, yc::Integer, width::Integer, height::Integer, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdSimSector, libcd_), Cvoid, (Ptr{Cvoid}, Cint, Cint, Cint, Cint, Cdouble, Cdouble), ctxcanvas, xc, yc, width, height, angle1, angle2)
end

function cdSimChord(ctxcanvas::Ptr{Cvoid}, xc::Integer, yc::Integer, width::Integer, height::Integer, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdSimChord, libcd_), Cvoid, (Ptr{Cvoid}, Cint, Cint, Cint, Cint, Cdouble, Cdouble), ctxcanvas, xc, yc, width, height, angle1, angle2)
end

function cdSimPoly(ctxcanvas::Ptr{Cvoid}, mode::Integer, points::Ptr{cdPoint}, n::Integer)
  ccall( (:cdSimPoly, libcd_), Cvoid, (Ptr{Cvoid}, Cint, Ptr{cdPoint}, Cint), ctxcanvas, mode, points, n)
end

function cdSimPolyBezier(canvas::Ptr{Cint}, points::Ptr{cdPoint}, n::Integer)
  ccall( (:cdSimPolyBezier, libcd_), Cvoid, (Ptr{Cint}, Ptr{cdPoint}, Cint), canvas, points, n)
end

function cdSimPolyPath(canvas::Ptr{Cint}, points::Ptr{cdPoint}, n::Integer)
  ccall( (:cdSimPolyPath, libcd_), Cvoid, (Ptr{Cint}, Ptr{cdPoint}, Cint), canvas, points, n)
end

function cdfSimLine(ctxcanvas::Ptr{Cvoid}, x1::Cdouble, y1::Cdouble, x2::Cdouble, y2::Cdouble)
  ccall( (:cdfSimLine, libcd_), Cvoid, (Ptr{Cvoid}, Cdouble, Cdouble, Cdouble, Cdouble), ctxcanvas, x1, y1, x2, y2)
end

function cdfSimRect(ctxcanvas::Ptr{Cvoid}, xmin::Cdouble, xmax::Cdouble, ymin::Cdouble, ymax::Cdouble)
  ccall( (:cdfSimRect, libcd_), Cvoid, (Ptr{Cvoid}, Cdouble, Cdouble, Cdouble, Cdouble), ctxcanvas, xmin, xmax, ymin, ymax)
end

function cdfSimBox(ctxcanvas::Ptr{Cvoid}, xmin::Cdouble, xmax::Cdouble, ymin::Cdouble, ymax::Cdouble)
  ccall( (:cdfSimBox, libcd_), Cvoid, (Ptr{Cvoid}, Cdouble, Cdouble, Cdouble, Cdouble), ctxcanvas, xmin, xmax, ymin, ymax)
end

function cdfSimArc(ctxcanvas::Ptr{Cvoid}, xc::Cdouble, yc::Cdouble, width::Cdouble, height::Cdouble, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdfSimArc, libcd_), Cvoid, (Ptr{Cvoid}, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble), ctxcanvas, xc, yc, width, height, angle1, angle2)
end

function cdfSimSector(ctxcanvas::Ptr{Cvoid}, xc::Cdouble, yc::Cdouble, width::Cdouble, height::Cdouble, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdfSimSector, libcd_), Cvoid, (Ptr{Cvoid}, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble), ctxcanvas, xc, yc, width, height, angle1, angle2)
end

function cdfSimChord(ctxcanvas::Ptr{Cvoid}, xc::Cdouble, yc::Cdouble, width::Cdouble, height::Cdouble, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdfSimChord, libcd_), Cvoid, (Ptr{Cvoid}, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble), ctxcanvas, xc, yc, width, height, angle1, angle2)
end

function cdfSimPoly(ctxcanvas::Ptr{Cvoid}, mode::Integer, fpoly::Ptr{cdfPoint}, n::Integer)
  ccall( (:cdfSimPoly, libcd_), Cvoid, (Ptr{Cvoid}, Cint, Ptr{cdfPoint}, Cint), ctxcanvas, mode, fpoly, n)
end

function cdfSimPolyBezier(canvas::Ptr{Cint}, points::Ptr{cdfPoint}, n::Integer)
  ccall( (:cdfSimPolyBezier, libcd_), Cvoid, (Ptr{Cint}, Ptr{cdfPoint}, Cint), canvas, points, n)
end

function cdfSimPolyPath(canvas::Ptr{Cint}, points::Ptr{cdfPoint}, n::Integer)
  ccall( (:cdfSimPolyPath, libcd_), Cvoid, (Ptr{Cint}, Ptr{cdfPoint}, Cint), canvas, points, n)
end
...
function cdCreateCanvas(context::Ptr{cdContext}, data::Ptr{Cvoid})
  ccall( (:cdCreateCanvas, libcd_), Ptr{cdCanvas}, (Ptr{cdContext}, Ptr{Cvoid}), context, data)
end

function cdCreateCanvas(context::Ptr{cdContext}, data::Ptr{Cchar})
  ccall( (:cdCreateCanvas, libcd_), Ptr{cdCanvas}, (Ptr{cdContext}, Ptr{Cvoid}), context, data)
end

function cdKillCanvas(canvas::Ptr{cdCanvas})
  ccall( (:cdKillCanvas, libcd_), Cvoid, (Ptr{cdCanvas},), canvas)
end
...
function cdCanvasDeactivate(canvas::Ptr{cdCanvas})
  ccall( (:cdCanvasDeactivate, libcd_), Cvoid, (Ptr{cdCanvas},), canvas)
end
...
function cdInitContextPlus()
  ccall( (:cdInitContextPlus, libcd_), Cvoid, (), )
end

function cdFinishContextPlus()
  ccall( (:cdFinishContextPlus, libcd_), Cvoid, (), )
end
...
function cdCanvasFlush(canvas::Ptr{cdCanvas})
  ccall( (:cdCanvasFlush, libcd_), Cvoid, (Ptr{cdCanvas},), canvas)
end

function cdCanvasClear(canvas::Ptr{cdCanvas})
  ccall( (:cdCanvasClear, libcd_), Cvoid, (Ptr{cdCanvas},), canvas)
end
...
function cdCanvasRestoreState(canvas::Ptr{cdCanvas}, state::Ptr{cdCanvas})
  ccall( (:cdCanvasRestoreState, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{cdCanvas}), canvas, state)
end

function cdReleaseState(state::Ptr{cdCanvas})
  ccall( (:cdReleaseState, libcd_), Cvoid, (Ptr{cdCanvas},), state)
end

function cdCanvasSetAttribute(canvas::Ptr{cdCanvas}, name, data)
  ccall( (:cdCanvasSetAttribute, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{UInt8}, Ptr{UInt8}), canvas, name, data)
end
...
function cdCanvasPlay(canvas::Ptr{cdCanvas}, context::Ptr{cdContext}, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer, data::Ptr{Cvoid})
  ccall( (:cdCanvasPlay, libcd_), Cint, (Ptr{cdCanvas}, Ptr{cdContext}, Cint, Cint, Cint, Cint, Ptr{Cvoid}), canvas, context, xmin, xmax, ymin, ymax, data)
end
...
function cdCanvasGetSize(canvas::Ptr{cdCanvas}, width::Ptr{Cint}, height::Ptr{Cint}, width_mm::Ptr{Cdouble}=C_NULL, height_mm::Ptr{Cdouble}=C_NULL)
    ccall( (:cdCanvasGetSize, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}),
        canvas, width, height, width_mm, height_mm)
end

function cdCanvasGetSize(canvas::Ptr{cdCanvas}, width::Ptr{Cint}, height::Ptr{Cint}, width_mm::Ptr{Cvoid}, height_mm::Ptr{Cvoid})
    ccall( (:cdCanvasGetSize, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}),
        canvas, width, height, width_mm, height_mm)
end
...
function cdCanvasMM2Pixel(canvas::Ptr{cdCanvas}, mm_dx::Cdouble, mm_dy::Cdouble, dx::Ptr{Cint}, dy::Ptr{Cint})
  ccall( (:cdCanvasMM2Pixel, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Ptr{Cint}, Ptr{Cint}), canvas, mm_dx, mm_dy, dx, dy)
end

function cdCanvasPixel2MM(canvas::Ptr{cdCanvas}, dx::Integer, dy::Integer, mm_dx::Ptr{Cdouble}, mm_dy::Ptr{Cdouble})
  ccall( (:cdCanvasPixel2MM, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{Cdouble}, Ptr{Cdouble}), canvas, dx, dy, mm_dx, mm_dy)
end

function cdfCanvasMM2Pixel(canvas::Ptr{cdCanvas}, mm_dx::Cdouble, mm_dy::Cdouble, dx::Ptr{Cdouble}, dy::Ptr{Cdouble})
  ccall( (:cdfCanvasMM2Pixel, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}), canvas, mm_dx, mm_dy, dx, dy)
end

function cdfCanvasPixel2MM(canvas::Ptr{cdCanvas}, dx::Cdouble, dy::Cdouble, mm_dx::Ptr{Cdouble}, mm_dy::Ptr{Cdouble})
  ccall( (:cdfCanvasPixel2MM, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}), canvas, dx, dy, mm_dx, mm_dy)
end

function cdCanvasOrigin(canvas::Ptr{cdCanvas}, x::Integer, y::Integer)
  ccall( (:cdCanvasOrigin, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint), canvas, x, y)
end

function cdfCanvasOrigin(canvas::Ptr{cdCanvas}, x::Cdouble, y::Cdouble)
  ccall( (:cdfCanvasOrigin, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble), canvas, x, y)
end

function cdCanvasGetOrigin(canvas::Ptr{cdCanvas}, x::Ptr{Cint}, y::Ptr{Cint})
  ccall( (:cdCanvasGetOrigin, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{Cint}, Ptr{Cint}), canvas, x, y)
end

function cdfCanvasGetOrigin(canvas::Ptr{cdCanvas}, x::Ptr{Cdouble}, y::Ptr{Cdouble})
  ccall( (:cdfCanvasGetOrigin, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{Cdouble}, Ptr{Cdouble}), canvas, x, y)
end

function cdCanvasTransform(canvas::Ptr{cdCanvas}, matrix::Ptr{Cdouble})
  ccall( (:cdCanvasTransform, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{Cdouble}), canvas, matrix)
end
...
function cdCanvasTransformMultiply(canvas::Ptr{cdCanvas}, matrix::Ptr{Cdouble})
  ccall( (:cdCanvasTransformMultiply, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{Cdouble}), canvas, matrix)
end

function cdCanvasTransformRotate(canvas::Ptr{cdCanvas}, angle::Cdouble)
  ccall( (:cdCanvasTransformRotate, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble), canvas, angle)
end

function cdCanvasTransformScale(canvas::Ptr{cdCanvas}, sx::Cdouble, sy::Cdouble)
  ccall( (:cdCanvasTransformScale, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble), canvas, sx, sy)
end

function cdCanvasTransformTranslate(canvas::Ptr{cdCanvas}, dx::Cdouble, dy::Cdouble)
  ccall( (:cdCanvasTransformTranslate, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble), canvas, dx, dy)
end

function cdCanvasTransformPoint(canvas::Ptr{cdCanvas}, x::Integer, y::Integer, tx::Ptr{Cint}, ty::Ptr{Cint})
  ccall( (:cdCanvasTransformPoint, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{Cint}, Ptr{Cint}), canvas, x, y, tx, ty)
end

function cdfCanvasTransformPoint(canvas::Ptr{cdCanvas}, x::Cdouble, y::Cdouble, tx::Ptr{Cdouble}, ty::Ptr{Cdouble})
  ccall( (:cdfCanvasTransformPoint, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}), canvas, x, y, tx, ty)
end
...
function cdCanvasClipArea(canvas::Ptr{cdCanvas}, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdCanvasClipArea, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Cint, Cint), canvas, xmin, xmax, ymin, ymax)
end
...
function cdfCanvasClipArea(canvas::Ptr{cdCanvas}, xmin::Cdouble, xmax::Cdouble, ymin::Cdouble, ymax::Cdouble)
  ccall( (:cdfCanvasClipArea, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Cdouble, Cdouble), canvas, xmin, xmax, ymin, ymax)
end
...
function cdCanvasOffsetRegion(canvas::Ptr{cdCanvas}, x::Integer, y::Integer)
  ccall( (:cdCanvasOffsetRegion, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint), canvas, x, y)
end

function cdCanvasGetRegionBox(canvas::Ptr{cdCanvas}, xmin::Ptr{Cint}, xmax::Ptr{Cint}, ymin::Ptr{Cint}, ymax::Ptr{Cint})
  ccall( (:cdCanvasGetRegionBox, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), canvas, xmin, xmax, ymin, ymax)
end
...
function cdCanvasPixel(canvas::Ptr{cdCanvas}, x::Integer, y::Integer, color::Clong)
  ccall( (:cdCanvasPixel, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Clong), canvas, x, y, color)
end

function cdCanvasMark(canvas::Ptr{cdCanvas}, x::Integer, y::Integer)
  ccall( (:cdCanvasMark, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint), canvas, x, y)
end

function cdCanvasBegin(canvas::Ptr{cdCanvas}, mode::Integer)
  ccall( (:cdCanvasBegin, libcd_), Cvoid, (Ptr{cdCanvas}, Cint), canvas, mode)
end

function cdCanvasPathSet(canvas::Ptr{cdCanvas}, action::Integer)
  ccall( (:cdCanvasPathSet, libcd_), Cvoid, (Ptr{cdCanvas}, Cint), canvas, action)
end

function cdCanvasEnd(canvas::Ptr{cdCanvas})
  ccall( (:cdCanvasEnd, libcd_), Cvoid, (Ptr{cdCanvas},), canvas)
end

function cdCanvasLine(canvas::Ptr{cdCanvas}, x1::Integer, y1::Integer, x2::Integer, y2::Integer)
  ccall( (:cdCanvasLine, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Cint, Cint), canvas, x1, y1, x2, y2)
end

function cdCanvasVertex(canvas::Ptr{cdCanvas}, x::Integer, y::Integer)
  ccall( (:cdCanvasVertex, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint), canvas, x, y)
end

function cdCanvasRect(canvas::Ptr{cdCanvas}, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdCanvasRect, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Cint, Cint), canvas, xmin, xmax, ymin, ymax)
end

function cdCanvasBox(canvas::Ptr{cdCanvas}, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdCanvasBox, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Cint, Cint), canvas, xmin, xmax, ymin, ymax)
end

function cdCanvasArc(canvas::Ptr{cdCanvas}, xc::Integer, yc::Integer, w::Integer, h::Integer, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdCanvasArc, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Cint, Cint, Cdouble, Cdouble), canvas, xc, yc, w, h, angle1, angle2)
end

function cdCanvasSector(canvas::Ptr{cdCanvas}, xc::Integer, yc::Integer, w::Integer, h::Integer, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdCanvasSector, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Cint, Cint, Cdouble, Cdouble), canvas, xc, yc, w, h, angle1, angle2)
end

function cdCanvasChord(canvas::Ptr{cdCanvas}, xc::Integer, yc::Integer, w::Integer, h::Integer, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdCanvasChord, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Cint, Cint, Cdouble, Cdouble), canvas, xc, yc, w, h, angle1, angle2)
end

function cdCanvasText(canvas::Ptr{cdCanvas}, x::Integer, y::Integer, s::Ptr{UInt8})
    ccall( (:cdCanvasText, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{UInt8}), canvas, x, y, s)
end
...
function cdfCanvasLine(canvas::Ptr{cdCanvas}, x1::Cdouble, y1::Cdouble, x2::Cdouble, y2::Cdouble)
  ccall( (:cdfCanvasLine, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Cdouble, Cdouble), canvas, x1, y1, x2, y2)
end

function cdfCanvasVertex(canvas::Ptr{cdCanvas}, x::Cdouble, y::Cdouble)
  ccall( (:cdfCanvasVertex, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble), canvas, x, y)
end

function cdfCanvasRect(canvas::Ptr{cdCanvas}, xmin::Cdouble, xmax::Cdouble, ymin::Cdouble, ymax::Cdouble)
  ccall( (:cdfCanvasRect, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Cdouble, Cdouble), canvas, xmin, xmax, ymin, ymax)
end

function cdfCanvasBox(canvas::Ptr{cdCanvas}, xmin::Cdouble, xmax::Cdouble, ymin::Cdouble, ymax::Cdouble)
  ccall( (:cdfCanvasBox, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Cdouble, Cdouble), canvas, xmin, xmax, ymin, ymax)
end

function cdfCanvasArc(canvas::Ptr{cdCanvas}, xc::Cdouble, yc::Cdouble, w::Cdouble, h::Cdouble, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdfCanvasArc, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble), canvas, xc, yc, w, h, angle1, angle2)
end

function cdfCanvasSector(canvas::Ptr{cdCanvas}, xc::Cdouble, yc::Cdouble, w::Cdouble, h::Cdouble, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdfCanvasSector, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble), canvas, xc, yc, w, h, angle1, angle2)
end

function cdfCanvasChord(canvas::Ptr{cdCanvas}, xc::Cdouble, yc::Cdouble, w::Cdouble, h::Cdouble, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdfCanvasChord, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble), canvas, xc, yc, w, h, angle1, angle2)
end

function cdfCanvasText(canvas::Ptr{cdCanvas}, x::Cdouble, y::Cdouble, s::Ptr{UInt8})
  ccall( (:cdfCanvasText, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Ptr{UInt8}), canvas, x, y, s)
end

function cdCanvasSetBackground(canvas::Ptr{cdCanvas}, color::Integer)
  ccall( (:cdCanvasSetBackground, libcd_), Cvoid, (Ptr{cdCanvas}, Clong), canvas, color)
end

function cdCanvasSetForeground(canvas::Ptr{cdCanvas}, color::Integer)
  ccall( (:cdCanvasSetForeground, libcd_), Cvoid, (Ptr{cdCanvas}, Clong), canvas, color)
end
...
function cdCanvasLineStyleDashes(canvas::Ptr{cdCanvas}, dashes::Ptr{Cint}, count::Integer)
  ccall( (:cdCanvasLineStyleDashes, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{Cint}, Cint), canvas, dashes, count)
end
...
function cdCanvasStipple(canvas::Ptr{cdCanvas}, w::Integer, h::Integer, stipple::Ptr{Cuchar})
  ccall( (:cdCanvasStipple, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{Cuchar}), canvas, w, h, stipple)
end
...
function cdCanvasPattern(canvas::Ptr{cdCanvas}, w::Integer, h::Integer, pattern::Ptr{Clong})
  ccall( (:cdCanvasPattern, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{Clong}), canvas, w, h, pattern)
end
...
function cdCanvasFont(canvas::Ptr{cdCanvas}, type_face::Ptr{Cvoid}, style::Integer, size::Integer)
  ccall( (:cdCanvasFont, libcd_), Cint, (Ptr{cdCanvas}, Ptr{UInt8}, Cint, Cint), canvas, type_face, style, size)
end

function cdCanvasGetFont(canvas::Ptr{cdCanvas}, type_face::Ptr{UInt8}, style::Ptr{Cint}, size::Ptr{Cint})
  ccall( (:cdCanvasGetFont, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{UInt8}, Ptr{Cint}, Ptr{Cint}), canvas, type_face, style, size)
end
...
function cdCanvasVectorText(canvas::Ptr{cdCanvas}, x::Integer, y::Integer, s::Ptr{UInt8})
  ccall( (:cdCanvasVectorText, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{UInt8}), canvas, x, y, s)
end

function cdCanvasMultiLineVectorText(canvas::Ptr{cdCanvas}, x::Integer, y::Integer, s::Ptr{UInt8})
  ccall( (:cdCanvasMultiLineVectorText, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{UInt8}), canvas, x, y, s)
end
...
function cdCanvasVectorTextDirection(canvas::Ptr{cdCanvas}, x1::Integer, y1::Integer, x2::Integer, y2::Integer)
  ccall( (:cdCanvasVectorTextDirection, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Cint, Cint), canvas, x1, y1, x2, y2)
end
...
function cdCanvasVectorTextSize(canvas::Ptr{cdCanvas}, size_x::Integer, size_y::Integer, s::Ptr{UInt8})
  ccall( (:cdCanvasVectorTextSize, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{UInt8}), canvas, size_x, size_y, s)
end
...
function cdCanvasVectorFontSize(canvas::Ptr{cdCanvas}, size_x::Cdouble, size_y::Cdouble)
  ccall( (:cdCanvasVectorFontSize, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble), canvas, size_x, size_y)
end

function cdCanvasGetVectorFontSize(canvas::Ptr{cdCanvas}, size_x::Ptr{Cdouble}, size_y::Ptr{Cdouble})
  ccall( (:cdCanvasGetVectorFontSize, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{Cdouble}, Ptr{Cdouble}), canvas, size_x, size_y)
end

function cdCanvasGetVectorTextSize(canvas::Ptr{cdCanvas}, s::Ptr{UInt8}, x::Ptr{Cint}, y::Ptr{Cint})
  ccall( (:cdCanvasGetVectorTextSize, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{UInt8}, Ptr{Cint}, Ptr{Cint}), canvas, s, x, y)
end

function cdCanvasGetVectorTextBounds(canvas::Ptr{cdCanvas}, s::Ptr{UInt8}, x::Integer, y::Integer, rect::Ptr{Cint})
  ccall( (:cdCanvasGetVectorTextBounds, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{UInt8}, Cint, Cint, Ptr{Cint}), canvas, s, x, y, rect)
end
...
function cdCanvasGetVectorTextBox(canvas::Ptr{cdCanvas}, x::Integer, y::Integer, s::Ptr{UInt8}, xmin::Ptr{Cint}, xmax::Ptr{Cint}, ymin::Ptr{Cint}, ymax::Ptr{Cint})
  ccall( (:cdCanvasGetVectorTextBox, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{UInt8}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), canvas, x, y, s, xmin, xmax, ymin, ymax)
end

function cdfCanvasVectorTextDirection(canvas::Ptr{cdCanvas}, x1::Cdouble, y1::Cdouble, x2::Cdouble, y2::Cdouble)
  ccall( (:cdfCanvasVectorTextDirection, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Cdouble, Cdouble), canvas, x1, y1, x2, y2)
end

function cdfCanvasVectorTextSize(canvas::Ptr{cdCanvas}, size_x::Cdouble, size_y::Cdouble, s::Ptr{UInt8})
  ccall( (:cdfCanvasVectorTextSize, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Ptr{UInt8}), canvas, size_x, size_y, s)
end

function cdfCanvasGetVectorTextSize(canvas::Ptr{cdCanvas}, s::Ptr{UInt8}, x::Ptr{Cdouble}, y::Ptr{Cdouble})
  ccall( (:cdfCanvasGetVectorTextSize, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{UInt8}, Ptr{Cdouble}, Ptr{Cdouble}), canvas, s, x, y)
end
...
function cdfCanvasVectorText(canvas::Ptr{cdCanvas}, x::Cdouble, y::Cdouble, s::Ptr{UInt8})
  ccall( (:cdfCanvasVectorText, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Ptr{UInt8}), canvas, x, y, s)
end

function cdfCanvasMultiLineVectorText(canvas::Ptr{cdCanvas}, x::Cdouble, y::Cdouble, s::Ptr{UInt8})
  ccall( (:cdfCanvasMultiLineVectorText, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Ptr{UInt8}), canvas, x, y, s)
end

function cdfCanvasGetVectorTextBounds(canvas::Ptr{cdCanvas}, s::Ptr{UInt8}, x::Cdouble, y::Cdouble, rect::Ptr{Cdouble})
  ccall( (:cdfCanvasGetVectorTextBounds, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{UInt8}, Cdouble, Cdouble, Ptr{Cdouble}), canvas, s, x, y, rect)
end
...
function cdfCanvasGetVectorTextBox(canvas::Ptr{cdCanvas}, x::Cdouble, y::Cdouble, s::Ptr{UInt8}, xmin::Ptr{Cdouble}, xmax::Ptr{Cdouble}, ymin::Ptr{Cdouble}, ymax::Ptr{Cdouble})
  ccall( (:cdfCanvasGetVectorTextBox, libcd_), Cvoid, (Ptr{cdCanvas}, Cdouble, Cdouble, Ptr{UInt8}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), canvas, x, y, s, xmin, xmax, ymin, ymax)
end

function cdCanvasGetFontDim(canvas::Ptr{cdCanvas}, max_width::Ptr{Cint}, height::Ptr{Cint}, ascent::Ptr{Cint}, descent::Ptr{Cint})
  ccall( (:cdCanvasGetFontDim, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), canvas, max_width, height, ascent, descent)
end

function cdCanvasGetTextSize(canvas::Ptr{cdCanvas}, s::Ptr{UInt8}, width::Ptr{Cint}, height::Ptr{Cint})
  ccall( (:cdCanvasGetTextSize, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{UInt8}, Ptr{Cint}, Ptr{Cint}), canvas, s, width, height)
end
...
function cdCanvasGetTextBox(canvas::Ptr{cdCanvas}, x::Integer, y::Integer, s::Ptr{UInt8}, xmin::Ptr{Cint}, xmax::Ptr{Cint}, ymin::Ptr{Cint}, ymax::Ptr{Cint})
  ccall( (:cdCanvasGetTextBox, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{UInt8}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), canvas, x, y, s, xmin, xmax, ymin, ymax)
end

function cdCanvasGetTextBounds(canvas::Ptr{cdCanvas}, x::Integer, y::Integer, s::Ptr{UInt8}, rect::Ptr{Cint})
  ccall( (:cdCanvasGetTextBounds, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{UInt8}, Ptr{Cint}), canvas, x, y, s, rect)
end
...
function cdCanvasPalette(canvas::Ptr{cdCanvas}, n::Integer, palette::Ptr{Clong}, mode::Integer)
  ccall( (:cdCanvasPalette, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Ptr{Clong}, Cint), canvas, n, palette, mode)
end
...
function cdCanvasGetImageRGB(canvas::Ptr{cdCanvas}, r::Ptr{Cuchar}, g::Ptr{Cuchar}, b::Ptr{Cuchar}, x::Integer, y::Integer, w::Integer, h::Integer)
  ccall( (:cdCanvasGetImageRGB, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Cint, Cint, Cint, Cint), canvas, r, g, b, x, y, w, h)
end
...
function cdCanvasPutImageRectRGB(canvas::Ptr{cdCanvas}, iw::Integer, ih::Integer, r::Ptr{Cuchar}, g::Ptr{Cuchar}, b::Ptr{Cuchar}, x::Integer, y::Integer, w::Integer, h::Integer, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdCanvasPutImageRectRGB, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), canvas, iw, ih, r, g, b, x, y, w, h, xmin, xmax, ymin, ymax)
end
...
function cdCanvasPutImageRectRGBA(canvas::Ptr{cdCanvas}, iw::Integer, ih::Integer, r::Ptr{Cuchar}, g::Ptr{Cuchar}, b::Ptr{Cuchar}, a::Ptr{Cuchar}, x::Integer, y::Integer, w::Integer, h::Integer, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdCanvasPutImageRectRGBA, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), canvas, iw, ih, r, g, b, a, x, y, w, h, xmin, xmax, ymin, ymax)
end
...
function cdCanvasPutImageRectMap(canvas::Ptr{cdCanvas}, iw::Integer, ih::Integer, index::Ptr{Cuchar}, colors::Ptr{Clong}, x::Integer, y::Integer, w::Integer, h::Integer, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdCanvasPutImageRectMap, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Ptr{Cuchar}, Ptr{Clong}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), canvas, iw, ih, index, colors, x, y, w, h, xmin, xmax, ymin, ymax)
end
...
function cdKillImage(image::Ptr{cdImage})
  ccall( (:cdKillImage, libcd_), Cvoid, (Ptr{cdImage},), image)
end

function cdCanvasGetImage(canvas::Ptr{cdCanvas}, image::Ptr{cdImage}, x::Integer, y::Integer)
  ccall( (:cdCanvasGetImage, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{cdImage}, Cint, Cint), canvas, image, x, y)
end
...
function cdCanvasPutImageRect(canvas::Ptr{cdCanvas}, image::Ptr{cdImage}, x::Integer, y::Integer, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdCanvasPutImageRect, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{cdImage}, Cint, Cint, Cint, Cint, Cint, Cint), canvas, image, x, y, xmin, xmax, ymin, ymax)
end
...
function cdCanvasScrollArea(canvas::Ptr{cdCanvas}, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer, dx::Integer, dy::Integer)
  ccall( (:cdCanvasScrollArea, libcd_), Cvoid, (Ptr{cdCanvas}, Cint, Cint, Cint, Cint, Cint, Cint), canvas, xmin, xmax, ymin, ymax, dx, dy)
end
...
function cdKillBitmap(bitmap::Ptr{cdBitmap})
  ccall( (:cdKillBitmap, libcd_), Cvoid, (Ptr{cdBitmap},), bitmap)
end
...
function cdBitmapSetRect(bitmap::Ptr{cdBitmap}, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdBitmapSetRect, libcd_), Cvoid, (Ptr{cdBitmap}, Cint, Cint, Cint, Cint), bitmap, xmin, xmax, ymin, ymax)
end

function cdCanvasPutBitmap(canvas::Ptr{cdCanvas}, bitmap::Ptr{cdBitmap}, x::Integer, y::Integer, w::Integer, h::Integer)
  ccall( (:cdCanvasPutBitmap, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{cdBitmap}, Cint, Cint, Cint, Cint), canvas, bitmap, x, y, w, h)
end

function cdCanvasGetBitmap(canvas::Ptr{cdCanvas}, bitmap::Ptr{cdBitmap}, x::Integer, y::Integer)
  ccall( (:cdCanvasGetBitmap, libcd_), Cvoid, (Ptr{cdCanvas}, Ptr{cdBitmap}, Cint, Cint), canvas, bitmap, x, y)
end

function cdBitmapRGB2Map(bitmap_rgb::Ptr{cdBitmap}, bitmap_map::Ptr{cdBitmap})
  ccall( (:cdBitmapRGB2Map, libcd_), Cvoid, (Ptr{cdBitmap}, Ptr{cdBitmap}), bitmap_rgb, bitmap_map)
end
...
function cdDecodeColor(color::Integer, red::Ptr{Cuchar}, green::Ptr{Cuchar}, blue::Ptr{Cuchar})
  ccall( (:cdDecodeColor, libcd_), Cvoid, (Clong, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}), color, red, green, blue)
end
...
function cdRGB2Map(width::Integer, height::Integer, red::Ptr{Cuchar}, green::Ptr{Cuchar}, blue::Ptr{Cuchar}, index::Ptr{Cuchar}, pal_size::Integer, color::Ptr{Clong})
  ccall( (:cdRGB2Map, libcd_), Cvoid, (Cint, Cint, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Cint, Ptr{Clong}), width, height, red, green, blue, index, pal_size, color)
end
...
function cdFlush()
  ccall( (:cdFlush, libcd_), Cvoid, (), )
end

function cdClear()
  ccall( (:cdClear, libcd_), Cvoid, (), )
end
...
function cdRestoreState(state::Ptr{cdCanvas})
  ccall( (:cdRestoreState, libcd_), Cvoid, (Ptr{cdCanvas},), state)
end

function cdSetAttribute(name::Ptr{UInt8}, data::Ptr{UInt8})
  ccall( (:cdSetAttribute, libcd_), Cvoid, (Ptr{UInt8}, Ptr{UInt8}), name, data)
end
...
function cdPlay(context::Ptr{cdContext}, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer, data::Ptr{Cvoid})
  ccall( (:cdPlay, libcd_), Cint, (Ptr{cdContext}, Cint, Cint, Cint, Cint, Ptr{Cvoid}), context, xmin, xmax, ymin, ymax, data)
end

function cdGetCanvasSize(width::Ptr{Cint}, height::Ptr{Cint}, width_mm::Ptr{Cdouble}=C_NULL, height_mm::Ptr{Cdouble}=C_NULL)
  ccall( (:cdGetCanvasSize, libcd_), Cvoid, (Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}), width, height, width_mm, height_mm)
end

function cdGetCanvasSize(width::Ptr{Cint}, height::Ptr{Cint}, width_mm::Ptr{Cvoid}, height_mm::Ptr{Cvoid})
  ccall( (:cdGetCanvasSize, libcd_), Cvoid, (Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}), width, height, width_mm, height_mm)
end
...
function cdMM2Pixel(mm_dx::Cdouble, mm_dy::Cdouble, dx::Ptr{Cint}, dy::Ptr{Cint})
  ccall( (:cdMM2Pixel, libcd_), Cvoid, (Cdouble, Cdouble, Ptr{Cint}, Ptr{Cint}), mm_dx, mm_dy, dx, dy)
end

function cdPixel2MM(dx::Integer, dy::Integer, mm_dx::Ptr{Cdouble}, mm_dy::Ptr{Cdouble})
  ccall( (:cdPixel2MM, libcd_), Cvoid, (Cint, Cint, Ptr{Cdouble}, Ptr{Cdouble}), dx, dy, mm_dx, mm_dy)
end

function cdOrigin(x::Integer, y::Integer)
  ccall( (:cdOrigin, libcd_), Cvoid, (Cint, Cint), x, y)
end
...
function cdClipArea(xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdClipArea, libcd_), Cvoid, (Cint, Cint, Cint, Cint), xmin, xmax, ymin, ymax)
end
...
function cdOffsetRegion(x::Integer, y::Integer)
  ccall( (:cdOffsetRegion, libcd_), Cvoid, (Cint, Cint), x, y)
end

function cdRegionBox(xmin::Ptr{Cint}, xmax::Ptr{Cint}, ymin::Ptr{Cint}, ymax::Ptr{Cint})
  ccall( (:cdRegionBox, libcd_), Cvoid, (Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), xmin, xmax, ymin, ymax)
end
...
function cdPixel(x::Integer, y::Integer, color::Clong)
  ccall( (:cdPixel, libcd_), Cvoid, (Cint, Cint, Clong), x, y, color)
end

function cdMark(x::Integer, y::Integer)
  ccall( (:cdMark, libcd_), Cvoid, (Cint, Cint), x, y)
end

function cdLine(x1::Integer, y1::Integer, x2::Integer, y2::Integer)
  ccall( (:cdLine, libcd_), Cvoid, (Cint, Cint, Cint, Cint), x1, y1, x2, y2)
end

function cdBegin(mode::Integer)
  ccall( (:cdBegin, libcd_), Cvoid, (Cint,), mode)
end

function cdVertex(x::Integer, y::Integer)
  ccall( (:cdVertex, libcd_), Cvoid, (Cint, Cint), x, y)
end

function cdEnd()
  ccall( (:cdEnd, libcd_), Cvoid, (), )
end

function cdBox(xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdBox, libcd_), Cvoid, (Cint, Cint, Cint, Cint), xmin, xmax, ymin, ymax)
end

function cdArc(xc::Integer, yc::Integer, w::Integer, h::Integer, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdArc, libcd_), Cvoid, (Cint, Cint, Cint, Cint, Cdouble, Cdouble), xc, yc, w, h, angle1, angle2)
end

function cdSector(xc::Integer, yc::Integer, w::Integer, h::Integer, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdSector, libcd_), Cvoid, (Cint, Cint, Cint, Cint, Cdouble, Cdouble), xc, yc, w, h, angle1, angle2)
end

function cdChord(xc::Integer, yc::Integer, w::Integer, h::Integer, angle1::Cdouble, angle2::Cdouble)
  ccall( (:cdChord, libcd_), Cvoid, (Cint, Cint, Cint, Cint, Cdouble, Cdouble), xc, yc, w, h, angle1, angle2)
end

function cdText(x::Integer, y::Integer, s::Ptr{UInt8})
  ccall( (:cdText, libcd_), Cvoid, (Cint, Cint, Ptr{UInt8}), x, y, s)
end
...
function cdLineStyleDashes(dashes::Ptr{Cint}, count::Integer)
  ccall( (:cdLineStyleDashes, libcd_), Cvoid, (Ptr{Cint}, Cint), dashes, count)
end
...
function cdStipple(w::Integer, h::Integer, stipple::Ptr{Cuchar})
  ccall( (:cdStipple, libcd_), Cvoid, (Cint, Cint, Ptr{Cuchar}), w, h, stipple)
end
...
function cdPattern(w::Integer, h::Integer, pattern::Ptr{Clong})
  ccall( (:cdPattern, libcd_), Cvoid, (Cint, Cint, Ptr{Clong}), w, h, pattern)
end
...
function cdFont(type_face::Integer, style::Integer, size::Integer)
  ccall( (:cdFont, libcd_), Cvoid, (Cint, Cint, Cint), type_face, style, size)
end

function cdGetFont(type_face::Ptr{Cint}, style::Ptr{Cint}, size::Ptr{Cint})
  ccall( (:cdGetFont, libcd_), Cvoid, (Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), type_face, style, size)
end
...
function cdVectorText(x::Integer, y::Integer, s::Ptr{UInt8})
  ccall( (:cdVectorText, libcd_), Cvoid, (Cint, Cint, Ptr{UInt8}), x, y, s)
end

function cdMultiLineVectorText(x::Integer, y::Integer, s::Ptr{UInt8})
  ccall( (:cdMultiLineVectorText, libcd_), Cvoid, (Cint, Cint, Ptr{UInt8}), x, y, s)
end

function cdVectorTextDirection(x1::Integer, y1::Integer, x2::Integer, y2::Integer)
  ccall( (:cdVectorTextDirection, libcd_), Cvoid, (Cint, Cint, Cint, Cint), x1, y1, x2, y2)
end
...
function cdVectorTextSize(size_x::Integer, size_y::Integer, s::Ptr{UInt8})
  ccall( (:cdVectorTextSize, libcd_), Cvoid, (Cint, Cint, Ptr{UInt8}), size_x, size_y, s)
end
...
function cdGetVectorTextSize(s::Ptr{UInt8}, x::Ptr{Cint}, y::Ptr{Cint})
  ccall( (:cdGetVectorTextSize, libcd_), Cvoid, (Ptr{UInt8}, Ptr{Cint}, Ptr{Cint}), s, x, y)
end

function cdGetVectorTextBounds(s::Ptr{UInt8}, x::Integer, y::Integer, rect::Ptr{Cint})
  ccall( (:cdGetVectorTextBounds, libcd_), Cvoid, (Ptr{UInt8}, Cint, Cint, Ptr{Cint}), s, x, y, rect)
end

function cdFontDim(max_width::Ptr{Cint}, height::Ptr{Cint}, ascent::Ptr{Cint}, descent::Ptr{Cint})
  ccall( (:cdFontDim, libcd_), Cvoid, (Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), max_width, height, ascent, descent)
end

function cdTextSize(s::Ptr{UInt8}, width::Ptr{Cint}, height::Ptr{Cint})
  ccall( (:cdTextSize, libcd_), Cvoid, (Ptr{UInt8}, Ptr{Cint}, Ptr{Cint}), s, width, height)
end

function cdTextBox(x::Integer, y::Integer, s::Ptr{UInt8}, xmin::Ptr{Cint}, xmax::Ptr{Cint}, ymin::Ptr{Cint}, ymax::Ptr{Cint})
  ccall( (:cdTextBox, libcd_), Cvoid, (Cint, Cint, Ptr{UInt8}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), x, y, s, xmin, xmax, ymin, ymax)
end

function cdTextBounds(x::Integer, y::Integer, s::Ptr{UInt8}, rect::Ptr{Cint})
  ccall( (:cdTextBounds, libcd_), Cvoid, (Cint, Cint, Ptr{UInt8}, Ptr{Cint}), x, y, s, rect)
end
...
function cdPalette(n::Integer, palette::Ptr{Clong}, mode::Integer)
  ccall( (:cdPalette, libcd_), Cvoid, (Cint, Ptr{Clong}, Cint), n, palette, mode)
end

function cdGetImageRGB(r::Ptr{Cuchar}, g::Ptr{Cuchar}, b::Ptr{Cuchar}, x::Integer, y::Integer, w::Integer, h::Integer)
  ccall( (:cdGetImageRGB, libcd_), Cvoid, (Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Cint, Cint, Cint, Cint), r, g, b, x, y, w, h)
end
...
function cdPutImageRectRGB(iw::Integer, ih::Integer, r::Ptr{Cuchar}, g::Ptr{Cuchar}, b::Ptr{Cuchar}, x::Integer, y::Integer, w::Integer, h::Integer, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdPutImageRectRGB, libcd_), Cvoid, (Cint, Cint, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), iw, ih, r, g, b, x, y, w, h, xmin, xmax, ymin, ymax)
end
...
function cdPutImageRectRGBA(iw::Integer, ih::Integer, r::Ptr{Cuchar}, g::Ptr{Cuchar}, b::Ptr{Cuchar}, a::Ptr{Cuchar}, x::Integer, y::Integer, w::Integer, h::Integer, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdPutImageRectRGBA, libcd_), Cvoid, (Cint, Cint, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Ptr{Cuchar}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), iw, ih, r, g, b, a, x, y, w, h, xmin, xmax, ymin, ymax)
end
...
function cdPutImageRectMap(iw::Integer, ih::Integer, index::Ptr{Cuchar}, colors::Ptr{Clong}, x::Integer, y::Integer, w::Integer, h::Integer, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdPutImageRectMap, libcd_), Cvoid, (Cint, Cint, Ptr{Cuchar}, Ptr{Clong}, Cint, Cint, Cint, Cint, Cint, Cint, Cint, Cint), iw, ih, index, colors, x, y, w, h, xmin, xmax, ymin, ymax)
end
...
function cdGetImage(image::Ptr{cdImage}, x::Integer, y::Integer)
  ccall( (:cdGetImage, libcd_), Cvoid, (Ptr{cdImage}, Cint, Cint), image, x, y)
end

function cdPutImageRect(image::Ptr{cdImage}, x::Integer, y::Integer, xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer)
  ccall( (:cdPutImageRect, libcd_), Cvoid, (Ptr{cdImage}, Cint, Cint, Cint, Cint, Cint, Cint), image, x, y, xmin, xmax, ymin, ymax)
end

function cdScrollArea(xmin::Integer, xmax::Integer, ymin::Integer, ymax::Integer, dx::Integer, dy::Integer)
  ccall( (:cdScrollArea, libcd_), Cvoid, (Cint, Cint, Cint, Cint, Cint, Cint), xmin, xmax, ymin, ymax, dx, dy)
end

function cdPutBitmap(bitmap::Ptr{cdBitmap}, x::Integer, y::Integer, w::Integer, h::Integer)
  ccall( (:cdPutBitmap, libcd_), Cvoid, (Ptr{cdBitmap}, Cint, Cint, Cint, Cint), bitmap, x, y, w, h)
end

function cdGetBitmap(bitmap::Ptr{cdBitmap}, x::Integer, y::Integer)
  ccall( (:cdGetBitmap, libcd_), Cvoid, (Ptr{cdBitmap}, Cint, Cint), bitmap, x, y)
end
